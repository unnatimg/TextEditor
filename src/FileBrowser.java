...
public class FileBrowser extends JPanel implements ActionListener{
	...
	JTextField newFileField = new JTextField(10);
	ButtonGroup bg;
	File directory;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == open){
			...
			login.cardL.show(login, "editor");
		}
		if(e.getSource() == newFile){
			String file = directory.getName()+"\\"+newFileField.getText()+".txt";
			if(newFileField.getText().length() > 0 && !(new File(file).exists())){
